 ...
 * visual, shared with the privacy module (`privacy/src/topo.ts`). Reads as a
 * "monitored hillside": cool protective teal contours warming to amber/red at
 * the risk ridge.
 */
...
/** Neon cyan→amber→risk ramp from the Web3 concept. */
...
/** Hero terrain configuration used on the Levee landing page. */
